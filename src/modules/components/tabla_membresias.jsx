export default function TablaMembresias({data, changeUpdateAsignar, changeUpdate, planes}) {
    ...
    if (data !== null && Array.isArray(data)) {
        return (
            ...
            id="tablaclientes" className="min-w-full bg-white border border-gray-300 shadow-md rounded-lg overflow-hidden">
                <thead>
                         ...
                         <tr key={membresia.ID_Membresia}>
                            ...
                            <td className="border border-slate-700 grid grid-cols-1">
                                <button onClick={(e) => changeUpdate(
                                    ...
                                    <i className="fas fa-coins"></i> PAGAR
                                </button>
                                <button onClick={(e) => changeUpdateAsignar(
                                        ...
                                        <i className="fas fa-edit"></i> ASIGNAR
                                </button>
                            </td>
                        </tr>
                    ))
