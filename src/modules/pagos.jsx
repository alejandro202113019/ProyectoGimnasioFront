...
function Pago({loading, setLoading}) {
    ...
    const buscar = async (id) => {
        if (id === "") {
            ...
            try {
                setLoading(true)
                const result = await axios.get(`http://localhost:5001/api/pagos/${id}`);
    ...
    return (
        ...
        <>
            ...
            <div>
                <TablaPagos data={data} eliminar={eliminar} chageConfirmation={chageConfirmation}
